...
public class GuiHome extends AbstractMenu{
    ...
    protected void placeItems(Inventory inv) {
        ...
        int price1 = main.getConfig().getInt("home1.preis");
        ...
        int price2 = main.getConfig().getInt("home2.preis");
        ...
        int price3 = main.getConfig().getInt("home3.preis");
        ...
        int price4 = main.getConfig().getInt("home4.preis");
        ...
        int price5 = main.getConfig().getInt("home5.preis");
